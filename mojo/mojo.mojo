...
<project name="mojo" board="Mojo V3" language="Lucid">
  <files>
    <src>eightbitmod.luc</src>
    <src>eightbitxnor.luc</src>
    <src>eightbitand.luc</src>
    <src>eightbitor.luc</src>
    <src>eightbitnota.luc</src>
    <src>eightbitxor.luc</src>
    ...
    <src>eightbitdotproduct.luc</src>
    <src>eightbitsubtracter.luc</src>
