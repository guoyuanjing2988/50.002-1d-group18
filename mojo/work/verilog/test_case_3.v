...
module test_case_3 (
  ...
  wire [24-1:0] M_my_alu_io_led;
  wire [8-1:0] M_my_alu_led;
  alu_1 my_alu (
    .a(a),
    .b(b),
    .alufn(opcode),
    .io_led(M_my_alu_io_led),
    .led(M_my_alu_led)
  );
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      ADD_state: begin
        opcode = 6'h00;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h70 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = SUB_state;
        end
      end
      SUB_state: begin
        opcode = 6'h01;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'hd8 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = AND_state;
        end
      end
      AND_state: begin
        opcode = 6'h18;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h04 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = OR_state;
        end
      end
      OR_state: begin
        opcode = 6'h1e;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h6c && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = XOR_state;
        end
      end
      XOR_state: begin
        opcode = 6'h16;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h68 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = A_state;
        end
      end
      A_state: begin
        opcode = 6'h1a;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h24 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = SHL_state;
        end
      end
      SHL_state: begin
        ...
        alufn = opcode;
        b = 8'h02;
        if (M_my_alu_io_led[16+7-:8] == 8'h90 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = SHR_state;
        end
      end
      SHR_state: begin
        ...
        alufn = opcode;
        b = 8'h02;
        if (M_my_alu_io_led[16+7-:8] == 8'h09 && M_myBlinker_hold_time == 1'h1) begin
          M_state_d = SRA_state;
        end
      end
      SRA_state: begin
      ...
      CMPEQ_state: begin
        opcode = 6'h33;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h00 && M_myBlinker_hold_time == 1'h1) begin
      ...
      CMPLE_state: begin
        opcode = 6'h37;
        alufn = opcode;
        if (M_my_alu_io_led[16+7-:8] == 8'h01 && M_myBlinker_hold_time == 1'h1) begin
